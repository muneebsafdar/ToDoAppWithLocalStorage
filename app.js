document.addEventListener("DOMContentLoaded", function (e) {
  ...
  function createWholeTaskElement(task) {
    ...
    taskDiv.className ="task w-full flex justify-between bg-gray-600 p-2 mb-2 items-center rounded";
    paragrah.className = "font-bold text-white";
    DeleteButton.className ="border-[1px] border-white rounded px-5 py-2 bg-gray-800 text-white cursor-pointer";
